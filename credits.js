...
const TIERS = {
  ...
  // SWING_LEVEL mode and future deep-analytics surface (see alpacaKeys()'s
  ...
  shark: {
    ...
    dial:          false,       // Proposal 6, Aug 26 2026 -- Shark UI is shelved indefinitely, not rolled out here
    maxRollover:   45,
    price:         39.99,
  },
};
