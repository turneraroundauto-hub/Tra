...
app.post("/analyze", async (req, res) => {
  ...
  let barContext = "No opening bar data available — Alpaca not configured or market not yet open.";
  if (openingBarData) {
    ...
    barContext = `Opening bar (9:30-9:45am ET): O=${openingBarData.open} H=${openingBarData.high} L=${openingBarData.low} C=${openingBarData.close} Vol=${vStr} Direction=${openingBarData.direction}. Use this for Gate 3 — bullish/bearish engulf, volume confirmation, direction.`;
  }
