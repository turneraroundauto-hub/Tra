...
app.post("/stripe/webhook", express.raw({ type: "application/json" }), async (req, res) => {
  ...
  console.log(`[STRIPE WEBHOOK] Data keys: ${Object.keys(data).join(", ")}`);

  // Try multiple ways to find email — Stripe puts it in different places for different event types
  ...
  // Try multiple ways to find price ID
