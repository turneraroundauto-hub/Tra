...
app.post("/analyze", async (req, res) => {
  ...
  if (!isMarketOpen()) {
    return res.json({
      ...
      verdict: "FLAT",
      confidence: "LOW",
      reason: "Market is closed. Analysis runs during regular session hours (9:30am–4:00pm ET, Mon–Fri).",
      gates: {
        sector:       { status: "GREEN", note: "Market closed — no session data" },
        g1_prewindow: { status: "GREEN", note: "Market closed" },
        g2_catalyst:  { status: "GREEN", note: "Market closed" },
        g3_openbar:   { status: "YELLOW", note: "No opening bar — market closed" },
        g4_phase:     { status: "GREEN", note: "Market closed" },
        g5_korea:     { status: "GREEN", note: "Market closed" },
      },
      sizing: "NONE",
      wait_for: "Market open — 9:30am ET Monday through Friday.",
    });
  }
